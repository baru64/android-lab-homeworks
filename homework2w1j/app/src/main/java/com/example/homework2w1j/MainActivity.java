...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            currentPerson = savedInstanceState.getParcelable(CURRENT_TASK_KEY);
        }
    }
    @Override
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (currentPerson != null)
            outState.putParcelable(CURRENT_TASK_KEY, currentPerson);
    ...
    private void displayTaskInFragment(PersonListContent.Person person){
        ...
        if(person != null){
            personInfoFragment.displayTask(person);
        }
    }
